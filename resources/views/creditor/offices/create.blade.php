        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="{{ url('creditor_offices') }}" method="POST" class="row g-3 needs-validation" novalidate>
                ...
                <div class="col-md-4">
                  ...
                  <select name="group_key" class="form-select" id="" required>
                    ...
                    <option value="{{ $creditorGroup->key }}">{{ $creditorGroup->value }}</option>
                    @endforeach
                  </select>
