        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="{{ URL::to('paymentsFromClient/'.$paymentsFromClient->id.'/update') }}" method="POST" class="row g-3 needs-validation" novalidate>

                <input type="hidden" name="application_id" value="{{ $paymentsFromClient->application_id }}" id="application_id">
                {{-- 
                ...
                <div class="col-md-4">
                  ...
                  <x-text-input 
                    ...
                    name="amount" 
                    id="amount" 
                    :value="$paymentsFromClient->amount ?? old('amount')" 
                    required 
                  />
                ...
                <div class="col-md-4">
                  ...
                  <x-text-input 
                    ...
                    name="transaction_id" 
                    id="transactionID" 
                    :value="$paymentsFromClient->transaction_id ?? old('transaction_id')" 
                  />
                ...
                <div class="col-md-4">
                  ...
                  <x-text-input 
                    ...
                    name="payment_date" 
                    id="paymentDate" 
                    :value="$paymentsFromClient->payment_date ?? old('payment_date', date('Y-m-d'))" 
                    required 
                  />
