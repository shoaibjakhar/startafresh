        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="{{ URL::to('expenditure/'.$user->id.'/update') }}" method="POST" class="row g-3 needs-validation" novalidate>
                ...
                <input type="hidden" name="ids[]" value="{{ $clientExpenditure->id }}">
                <div class="row">
