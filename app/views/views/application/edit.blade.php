        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="{{ URL::to('applications/'.$application->id.'/update') }}" method="POST" class="row g-3 needs-validation" novalidate>
                ...
                <div class="col-md-4">
                    ...
                    <select name="user_id" class="form-select" id="" required>
                      ...
                      <option value="{{ $user->id }}" @if($user->id == $application->user_id) selected @endif>{{ $user->name }}</option>
                      @endforeach
                    </select>
                  ...
                  <div class="col-md-4">
                    ...
                    <select name="user_id2" class="form-select" id="" required>
                      <option selected disabled value="">Choose...</option>
                      @foreach($users as $user)
                      <option value="{{ $user->id }}" @if($user->id == $application->user_id2) selected @endif>{{ $user->name }}</option>
                      @endforeach
                    </select>
                ...
                <h5 class="card-title">Notes</h5>
                  <div class="col-md-8">
                    ...
                    <x-textarea 
                      ...
                      cols="" 
                      rows="5"
                      placeholder="Write Notes...">{{ $application->notes ?? old('notes') }}</x-textarea>
